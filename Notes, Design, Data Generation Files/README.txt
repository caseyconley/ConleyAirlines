...
*************************
	...
	c. Customer.java
		...
		The customer can also make a reservation, view their reservations, or cancel their reservation.
...
*****************
	...
	b. Database Administrator Interface
	...
	c. Customer Interface
		...
		i. Manage Credit Card Information
			1 --> Add a credit card
				Allows you to add a credit card to your account to pay for trips with. Credit card numbers are 16 digits long.
			2 --> View my credit card info
				Lists all the credit cards currently owned by the customer.
			3 --> Delete credit card
				Gives the option of removing a credit card.
			4 --> Go back
			
		ii. Make a reservation
			Enter an airport as a source and destination location. Then select a flight available, as well as your desired seat class. If seats are 
			available, you are prompted for which credit card to pay for the reservation. After selecting your credit card, a confirmation message will 				appear. When you are done placing a reservation, you are returned to the main menu.
		
		iii. View reservations
		...
		v. Close the Customer Interface and return to the main interface.
